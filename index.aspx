                ...
                <div class="content">
                    ...
                    <div class="col-1-2">
                        <article class="post-wrap">
                            <div class="post-img">
                                <a href="#0">
                                    <img src="images/post/post-n1.jpg" alt=""></a>
                            </div>
                            <div class="post">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nulla, sequi, quas, assumenda harum nam reiciendis obcaecati maxime <a href="#0">suscipit</a> quibusdam.
                                </p>
                                <a class="btn read-more" href="#0">Read More</a>
                            </div>
                        </article>
                    ...
                    <div class="col-1-2">
                        <article class="post-wrap">
                            <div class="post-img">
                                <a href="#0">
                                    <img src="images/post/post-n2.jpg" alt=""></a>
                            </div>
                            <div class="post">
                    ...
                    <div class="col-1-2">
                        <article class="post-wrap">
                            <div class="post-img">
                                <a href="#0">
                                    <img src="images/post/post-n3.jpg" alt=""></a>
                            </div>
                            <div class="post">
                    ...
                    <div class="col-1-2">
                        <article class="post-wrap">
                            <div class="post-img">
                                <a href="#0">
                                    <img src="images/post/post-n4.jpg" alt=""></a>
                            </div>
                            <div class="post">
                        ...
                        <section id="price-tables">
                            ...
                            <ul id="plans">
                                ...
                                <li class="plan best-plan">
                                    <ul class="plan-wrap">
                                        <li class="title">
                                            <h2 class="best-plan-title">Personal</h2>
                                        </li>
                                        <li class="price">
                                            <p class="best-plan-price">$20/m</p>
                                        </li>
                                        <li>
                                            <ul class="options">
                ...
                <div class="col-1-2 pleft-25">
                    <div class="content contact-form">
                        <form class="form">
                            ...
                            <asp:TextBox ID="tbIsim" runat="server" CssClass="comment-name" placeholder="İsim*" />

                            <asp:TextBox runat="server" CssClass="comment-email" ID="tbEposta" placeholder="Eposta*" />


                            <asp:TextBox runat="server" CssClass="comment-subject" placeholder="Konu" ID="tbKonu" />

                            <asp:TextBox runat="server" CssClass="required comment-text" placeholder="Mesajınız..." ID="tbMesajiniz" />



                            <asp:Button Text="Kaydet" CssClass="btn submit comment-submit" runat="server" ID="btKaydet" OnClick="btKaydet_Click" />
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="flickr-widget">
                                <ul class="flickr-list">
                                    <li><a href="#0">
                                        <img src="images/flickr-widget/flickr1.jpg" alt=""></a></li>
                                    <li><a href="#0">
                                        <img src="images/flickr-widget/flickr2.jpg" alt=""></a></li>
                                    <li><a href="#0">
                                        <img src="images/flickr-widget/flickr3.jpg" alt=""></a></li>
                                    <li><a href="#0">
                                        <img src="images/flickr-widget/flickr4.jpg" alt=""></a></li>
                                    <li><a href="#0">
                                        <img src="images/flickr-widget/flickr5.jpg" alt=""></a></li>
                                    <li><a href="#0">
                                        <img src="images/flickr-widget/flickr6.jpg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
